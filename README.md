...
客户使用钉钉考勤一段时间后，希望能通过对历史考勤数据的分析了解企业整体考勤情况是否有所改善，从时间、分支机构、部门等多个维度进行考勤达成率的对比，通过对比分析找出问题所在并做出相应的调整决策。

## 2. 项目结构

> **fronted**：前端模块，使用react构建，主要功能有：接入钉钉JSAPI获取authCode、展示考勤数据抓取页面、展示部门考勤数据。
>
> **backend**：后端模块，使用springboot构建，主要功能有：使用authCode获取access_token、使用access_token获取用户信息、获取部门人员信息、获取人员考勤数据等。
...
```shell
git clone https://github.com/open-dingtalk/h5app-attendance-achievement-demo.git
```
...
数据抓取页面 ![](https://img.alicdn.com/imgextra/i1/O1CN01cN2SGJ1Gjrk81ryoO_!!6000000000659-2-tps-800-381.png)

考勤数据 ![](https://img.alicdn.com/imgextra/i4/O1CN01VPv31Z1iE5VF6P2uN_!!6000000004380-2-tps-1000-439.png)


## 6. 参考文档

1. 获取企业内部应用access_token，文档链接：https://open.dingtalk.com/document/orgapp-server/obtain-orgapp-token
2. 查询是否启用智能统计报表，文档链接：https://open.dingtalk.com/document/orgapp-server/determine-whether-to-enable-attendance-intelligent-report
3. 获取通讯录权限范围，文档链接：https://open.dingtalk.com/document/orgapp-server/obtain-corpsecret-authorization-scope
4. 获取部门列表，文档链接：https://open.dingtalk.com/document/orgapp-server/obtain-the-department-list-v2
5. 获取部门用户基础信息，文档链接：https://open.dingtalk.com/document/orgapp-server/queries-the-simple-information-of-a-department-user
6. 获取考勤报表列定义，文档链接：https://open.dingtalk.com/document/orgapp-server/queries-the-enterprise-attendance-report-column
7. 获取考勤报表列值，文档链接：https://open.dingtalk.com/document/orgapp-server/obtains-the-column-values-of-the-smart-attendance-report
